...
def from_entity_to_db(entity: EntityT, db_cls: SqlAlchemyModelT) -> SqlAlchemyModelT:
...
def from_db_to_entity(db_model: SqlAlchemyModelT, entity_cls: EntityT) -> EntityT:
